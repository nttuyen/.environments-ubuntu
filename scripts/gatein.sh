...
export GATEIN_35_HOME=$HOME/projects/exo/gatein/gatein-portal/3.5.x
export GATEIN_36_HOME=$HOME/projects/exo/gatein/gatein-portal/3.6.x
export GATEIN_37_HOME=$HOME/projects/exo/gatein/gatein-portal/3.7.x
